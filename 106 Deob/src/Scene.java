...
public class Scene {
	public Scene(Surface surface, int i1, int j1, int k1) {
		dm = 50;
		em = new int[dm];
		fm = new int[dm][256];
		im = 5;
	...
	public int ej(int l, int i1, int j1, int k1, int l1, int i2) {
		...
		zn[tn] = i2;
		ao[tn] = 0;
		int j2 = bo.set_vertices(i1, j1, k1);
		int k2 = bo.set_vertices(i1, j1 - i2, k1);
		int ai1[] = { j2, k2 };
		bo.ue(2, ai1, 0, 0);
		bo.vh[tn++] = 0;
		return tn - 1;
	...
	public int sh(int l, int i1, int j1, int k1, int l1, int i2, int j2) {
		...
		zn[tn] = i2;
		ao[tn] = 0;
		int k2 = bo.set_vertices(i1, j1, k1);
		int l2 = bo.set_vertices(i1, j1 - i2, k1);
		int ai1[] = { k2, l2 };
		bo.ue(2, ai1, 0, 0);
		bo.uh[tn] = j2;
		bo.vh[tn++] = 0;
	...
	public void ki(int l, int i1, int j1, int k1, int l1, int i2) {
		...
		zm = l1;
		en = i2;
		vo = new Scanline[k1 + i1];
		for (int j2 = 0; j2 < k1 + i1; j2++)
			vo[j2] = new Scanline();

	}

	private void xh(Polygon aq[], int l, int i1) {
		if (l < i1) {
			int j1 = l - 1;
			int k1 = i1 + 1;
			int l1 = (l + i1) / 2;
	...
	public void oh(int l, Polygon aq[], int i1) {
		...
		do {
			...
			for (int j2 = i2; j2 >= l1 + 1; j2--) {
				Polygon q2 = aq[j2];
				if (q1.ghb < q2.ihb && q2.ghb < q1.ihb && q1.hhb < q2.jhb && q2.hhb < q1.jhb
						&& q1.vhb != q2.whb && !ph(q1, q2) && nh(q2, q1)) {
					bj(aq, l1, j2);
					if (aq[j2] != q2)
						j2++;
					l1 = lp;
	...
	public boolean bj(Polygon aq[], int l, int i1) {
		do {
			Polygon q1 = aq[l];
	...
	public void cj() {
		...
		for (int j4 = 0; j4 < mn; j4++) {
			Geometry h1 = on[j4];
			if (h1.jh) {
				for (int i1 = 0; i1 < h1.model_face_count; i1++) {
					int k4 = h1.face_vertex_count[i1];
					int ai2[] = h1.face_vertices[i1];
					boolean flag = false;
		...
		Geometry h2 = bo;
		if (h2.jh) {
			for (int j1 = 0; j1 < h2.model_face_count; j1++) {
				int ai1[] = h2.face_vertices[j1];
				int i5 = ai1[0];
				int k5 = h2.rg[i5];
				int k6 = h2.sg[i5];
				int l7 = h2.qg[i5];
		...
		for (int l4 = 0; l4 < qn; l4++) {
			...
			if (h3 == bo) {
				...
				if (sm && vm < wm) {
					k12 += (ao[k1] << en) / i10;
					if (um >= i13 && um <= i13 + j11 && tm >= k12 && tm <= k12 + l10 && !h3.zh
							&& h3.vh[k1] == 0) {
						xm[vm] = h3;
						ym[vm] = k1;
						vm++;
				...
				int j9 = 0;
				int i11 = 0;
				int k11 = h3.face_vertex_count[k1];
				int ai4[] = h3.face_vertices[k1];
				if (h3.face_intensity[k1] != 0xbc614e)
					if (q1.shb < 0)
						i11 = h3.sj - h3.face_intensity[k1];
					else
						i11 = h3.sj + h3.face_intensity[k1];
	...
	private void mh(int l, int i1, int j1, int k1, int l1, int ai1[], int ai2[], int ai3[],
			Geometry h1, int i2) {
		if (l1 == 3) {
			int j2 = ai2[0] + dn;
			int j3 = ai2[1] + dn;
	...
	private void wh(int l, int i1, int j1, int ai1[], int ai2[], int ai3[], int k1, Geometry h1) {
		if (k1 >= 0) {
			if (k1 >= go)
				k1 = 0;
			ri(k1);
			...
			if (jo[k1] == 1) {
				...
				if (h1.rh) {
					for (l = wo; l < xo; l += byte1) {
						...
						if (j21 <= 0) {
							...
							vi(uo, mo[k1], cm, cm, k10 + j15 * i1, j12 + l15 * i1, l13 + j16 * i1, j11, l12, j14,
									j21, l17 + i1, l22, j24 << 2);
							k10 += l11;
							j12 += j13;
							l13 += l14;
							l17 += j17;
				...
				if (!lo[k1]) {
					for (l = wo; l < xo; l += byte1) {
						...
						if (k21 <= 0) {
							...
							ai(uo, mo[k1], cm, cm, k10 + j15 * i1, j12 + l15 * i1, l13 + j16 * i1, j11, l12, j14,
									k21, l17 + i1, i23, k24 << 2);
							k10 += l11;
							j12 += j13;
							l13 += l14;
							l17 += j17;
				...
				for (l = wo; l < xo; l += byte1) {
					...
					if (l21 <= 0) {
						...
						oi(uo, cm, cm, cm, mo[k1], k10 + j15 * i1, j12 + l15 * i1, l13 + j16 * i1, j11, l12,
								j14, l21, l17 + i1, j23, l24);
						k10 += l11;
						j12 += j13;
						l13 += l14;
						l17 += j17;
			...
			if (h1.rh) {
				for (l = wo; l < xo; l += byte2) {
					...
					if (i22 <= 0) {
						...
						di(uo, mo[k1], cm, cm, l10 + k15 * i1, k12 + i16 * i1, i14 + k16 * i1, k11, i13, k14,
								i22, i18 + i1, k23, i25);
						l10 += i12;
						k12 += k13;
						i14 += i15;
			...
			if (!lo[k1]) {
				for (l = wo; l < xo; l += byte2) {
					...
					if (j22 <= 0) {
						...
						wi(uo, mo[k1], cm, cm, l10 + k15 * i1, k12 + i16 * i1, i14 + k16 * i1, k11, i13, k14,
								j22, i18 + i1, l23, j25);
						l10 += i12;
						k12 += k13;
						i14 += i15;
			...
			for (l = wo; l < xo; l += byte2) {
				...
				if (k22 <= 0) {
					...
					zh(uo, cm, cm, cm, mo[k1], l10 + k15 * i1, k12 + i16 * i1, i14 + k16 * i1, k11, i13, k14,
							k22, i18 + i1, i24, k25);
					l10 += i12;
					k12 += k13;
					i14 += i15;
	...
	private void dj(int l) {
		...
		Geometry h1 = q1.mhb;
		int i1 = q1.nhb;
		int ai1[] = h1.face_vertices[i1];
		int j1 = h1.face_vertex_count[i1];
		int k1 = h1.bh[i1];
		int i2 = h1.og[ai1[0]];
		int j2 = h1.pg[ai1[0]];
		int k2 = h1.qg[ai1[0]];
	...
	private boolean ph(Polygon q1, Polygon q2) {
		if (q1.ghb >= q2.ihb)
			return true;
		if (q2.ghb >= q1.ihb)
			return true;
		...
		int l = q1.nhb;
		int i1 = q2.nhb;
		int ai1[] = h1.face_vertices[l];
		int ai2[] = h2.face_vertices[i1];
		int j1 = h1.face_vertex_count[l];
		int k1 = h2.face_vertex_count[i1];
		int j3 = h2.og[ai2[0]];
		int k3 = h2.pg[ai2[0]];
		int l3 = h2.qg[ai2[0]];
		int i4 = q2.phb;
	...
	private boolean nh(Polygon q1, Polygon q2) {
		Geometry h1 = q1.mhb;
		Geometry h2 = q2.mhb;
		int l = q1.nhb;
		int i1 = q2.nhb;
	...
	public void lh(String s1, int l, int i1, int j1, GameShell k1) {
		try {
			oo = k1.unpack_archive(s1, "textures", j1);
			byte abyte0[] = Data.ln("textures.txt", 0, oo);
			Connection a1 = new Connection(abyte0);
			a1.zb();
			go = a1.gc();
			ho = new String[go];
			lo = new boolean[go];
	...
	public void si(String s1) {
		try {
			Connection a1 = new Connection(s1 + "/textures.txt");
			a1.zb();
			go = a1.gc();
			ho = new String[go];
			lo = new boolean[go];
			...
			for (int i1 = 0; i1 < go; i1++) {
				...
				Data.read_fully(s1 + "/" + ho[i1] + ".tga", ro, c);
				pi(i1);
			}
	...
	private void pi(int l) {
		...
		for (int j1 = 0; j1 < 256; j1++)
			so[j1] = ((ro[20 + j1 * 3] & 0xff) << 16) + ((ro[19 + j1 * 3] & 0xff) << 8)
					+ (ro[18 + j1 * 3] & 0xff);
	...
	public boolean rh(int ai1[], int ai2[], int ai3[], int ai4[]) {
			...
			if (ai2[j1] < ai2[k1]) {
				if (ai2[j1] < ai4[l1]) {
					if (ai2[j1] < ai4[i2]) {
						...
						int l16 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
								ai2[j1]);
					...
					int k12 = ai3[l1];
					int j17 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
							ai4[l1]);
				...
				if (ai2[k1] < ai4[i2]) {
					...
					int l17 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
							ai2[k1]);
				...
				int k13 = ai3[l1];
				int j18 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
						ai4[l1]);
		...
		while (byte0 == 1)
			if (ai2[j1] < ai4[l1]) {
				if (ai2[j1] < ai4[i2]) {
					...
					int l18 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
							ai2[j1]);
				...
				int k14 = ai3[l1];
				int j19 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
						ai4[l1]);
		...
		while (byte0 == 2)
			if (ai4[l1] < ai2[j1]) {
				...
				int l19 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
						ai2[k1]);
				...
				int i20 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
						ai2[j1]);
				...
				int j20 = uh(ai3[((i2 - 1) + i1) % i1], ai4[((i2 - 1) + i1) % i1], ai3[i2], ai4[i2],
						ai2[k1]);
