...
public class Config {
	public static void load() {
		try {
			load_projectiles(new Buffer("../gamedata/config/projectile.txt"));
			load_entities(new Buffer("../gamedata/config/entity.txt"));
			load_objects(new Buffer("../gamedata/config/objects.txt"));
			load_npcs(new Buffer("../gamedata/config/npc.txt"));
			load_locations(new Buffer("../gamedata/config/location.txt"));
			load_boundaries(new Buffer("../gamedata/config/boundary.txt"));
			load_roofs(new Buffer("../gamedata/config/roof.txt"));
			load_floors(new Buffer("../gamedata/config/floor.txt"));
			load_spells(new Buffer("../gamedata/config/spells.txt"));
			load_shops(new Buffer("../gamedata/config/shop.txt"));
			load_prayers(new Buffer("../gamedata/config/prayers.txt"));
			load_allowed_words(new Buffer("../gamedata/config/words.txt"));
			load_filtered_words(new Buffer("../gamedata/config/badwords.txt"));
			gq();
			return;
	...
	public static void load(byte data[]) {
		try {
			load_projectiles(new Buffer(data, Data.get_file_position("projectile.txt", data)));
			load_entities(new Buffer(data, Data.get_file_position("entity.txt", data)));
			load_objects(new Buffer(data, Data.get_file_position("objects.txt", data)));
			load_npcs(new Buffer(data, Data.get_file_position("npc.txt", data)));
			load_locations(new Buffer(data, Data.get_file_position("location.txt", data)));
			load_boundaries(new Buffer(data, Data.get_file_position("boundary.txt", data)));
			load_roofs(new Buffer(data, Data.get_file_position("roof.txt", data)));
			load_floors(new Buffer(data, Data.get_file_position("floor.txt", data)));
			load_spells(new Buffer(data, Data.get_file_position("spells.txt", data)));
			load_shops(new Buffer(data, Data.get_file_position("shop.txt", data)));
			load_prayers(new Buffer(data, Data.get_file_position("prayers.txt", data)));
			load_allowed_words(new Buffer(data, Data.get_file_position("words.txt", data)));
			load_filtered_words(new Buffer(data, Data.get_file_position("badwords.txt", data)));
			gq();
			return;
		} catch (IOException ioexception) {
			System.out.println("Error loading config files");
	...
	public static void load_allowed_words(Buffer f1) throws IOException {
		do {
			try {
				String s = f1.fc();
	...
	public static void load_filtered_words(Buffer f1) throws IOException {
		do {
			try {
				String s = f1.fc();
				if (s.equals("-EOF-") || (s == null || s.length() <= 0))
	...
	public static void load_shops(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		dmb = i;
	...
	public static void load_spells(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		vlb = i;
	...
	public static void load_prayers(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		nmb = i;
	...
	public static void load_projectiles(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		llb = i;
	...
	public static void gq() {
		for (int i = 0; i < llb; i++)
			tlb[i] = match_object(olb[i]);
	}

	public static void load_entities(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		xjb = i;
	...
	public static void load_npcs(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		tib = i;
	...
	public static void load_objects(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		yhb = i;
		...
		for (int j = 0; j < i; j++) {
			...
			lib[j] = f1.gc();
			mib[j] = f1.gc();
			nib[j] = match_projectile(f1.ac()) + 1;
			f1.zb();
			oib[j] = f1.gc();
			pib[j] = match_entity(f1.ac());
			qib[j] = f1.lb();
			rib[j] = f1.gc();
			sib[j] = f1.gc();
		}
	...
	public static void load_locations(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		fkb = i;
	...
	public static void load_boundaries(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		qkb = i;
	...
	public static void load_roofs(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		blb = i;
	...
	public static void load_floors(Buffer f1) throws IOException {
		f1.zb();
		int i = f1.gc();
		glb = i;
	...
	public static int match_entity(String s) {
	...
	public static int match_model(String s) {
		if (s.equalsIgnoreCase("na"))
			return 0;
		for (int i = 0; i < ymb; i++)
	...
	public static int match_object(String s) {
		if (s.equalsIgnoreCase("na"))
			return 0;
		for (int i = 0; i < yhb; i++) {
	...
	public static int match_projectile(String s) {
		if (s.equals("_"))
			return -1;
		for (int i = 0; i < llb; i++)
	...
	static String skill_names[] = { "attack", "defense", "strength", "hits", "ranged", "prayer",
			"magic", "cooking", "woodcutting", "fletching", "fishing", "firemaking", "crafting",
			"smithing", "mining", "herblaw" };
	public static String xmb[] = { "attack", "defense", "strength", "hits", "aggression", "bravery",
			"regenerate", "perception" };
	public static int ymb;
	public static String model_names[] = new String[200];
}